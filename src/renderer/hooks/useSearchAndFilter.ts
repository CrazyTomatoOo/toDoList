...
import type { TaskRow, Priority, TaskSearchFilters } from '../../shared/ipc'
...
export function useSearchAndFilter(
  ...
  const isFiltering = query.trim().length > 0 || priorityFilter !== '' || statusFilter !== 'all'
  ...
  }, [query, priorityFilter, statusFilter, selectedListId, isFiltering, tasks])
